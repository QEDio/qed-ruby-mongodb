...
describe Qed::Mongodb::MapReduce::Performer do
  ...
  context "performing mapreduce in the Universe" do
    before(:each) do
      ...
      Qed::Mongodb::Test::Factory::ScaleOfUniverse.
        big_bang(Qed::Mongodb::Test::Factory::ScaleOfUniverse::EXAMPLE_UNIVERSE)
    end
    ...
    context "to create a drilldown statistic five steps below the top view" do
      ...
      it "works flawlessly" do
        ...
        data.size.should == Qed::Mongodb::Test::Factory::ScaleOfUniverse.
                              line_items_with_same_value_in_dimension(data.first["_id"])

        data.each do |mr_result|
          mr_result["value"]["count"].should == Qed::Mongodb::Test::Factory::ScaleOfUniverse.
  ...
  context "performing mapreduce on a WorldWideBusiness" do
    before(:each) do
      ...
      Qed::Mongodb::Test::Factory::WorldWideBusiness.
        startup(Qed::Mongodb::Test::Factory::WorldWideBusiness::WORLD_WIDE_BUSINESS)
    end

    let(:fm) do
      fm                    = Qstate::FilterModel.new(Qed::Mongodb::Test::Factory::WorldWideBusiness::PARAMS_WORLD_WIDE_BUSINESS)
      fm.view.view          = Qed::Mongodb::Test::Factory::WorldWideBusiness::VIEW_LOC_DIM0
      fm.confidential.user  = :test
      fm
    end
    ...
    context "on the Dimension location" do
      ...
      context "to create a drilldown statistic one level below the top view" do
        before(:each) do
          fm.view.view = Qed::Mongodb::Test::Factory::WorldWideBusiness::VIEW_LOC_DIM1
        end
        ...
        it "returns the correct number of mapreduced datarows" do
          data.size.should ==
            Qed::Mongodb::Test::Factory::WorldWideBusiness.different_values_for_mr[mr_key].size
        end
      ...
      context "to create a drilldown statistic two level below the top view" do
        before(:each) do
          fm.view.view = Qed::Mongodb::Test::Factory::WorldWideBusiness::VIEW_LOC_DIM2
        end
      ...
      context "to create a drilldown statistic three level below the top view" do
        before(:each) do
          fm.view.view = Qed::Mongodb::Test::Factory::WorldWideBusiness::VIEW_LOC_DIM3
        end
